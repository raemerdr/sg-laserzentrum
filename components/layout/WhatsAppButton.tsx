...
/** WhatsApp's glyph (Simple Icons, CC0), drawn in currentColor to stay in the palette. */
const GLYPH =
...
/**
 * Floating WhatsApp button, bottom right on every page. On a studio page it
 * opens that studio's chat; elsewhere, and for studios without WhatsApp, the
 * central number.
 */
export default function WhatsAppButton() {
  ...
  const href = studio?.whatsapp ?? CONTACT.whatsapp;
  ...
  return (
    <a className={styles.button} href={href} target="_blank" rel="noopener noreferrer">
      ...
      <span className={styles.label}>{t.nav.whatsapp}</span>
